...
<body class="nk-body ui-rounder npc-default has-sidebar has-rtl" dir="rtl">
                                                            ...
                                                            <div class="drodown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <ul class="link-list-opt no-bdr">
                                                                        <li><a href="#" data-toggle="modal" data-target="#add-customer-modal"><span>اضافة عميل</span></a></li>
                                    ...
                                    <div class="card card-bordered card-stretch">
                                        <div class="card-inner-group">
                                            ...
                                            <div class="card-inner p-0">
                                                <table class="nk-tb-list nk-tb-ulist" id="customer-items">
                        ...
                        <div class="tab">
                            <form id="addCustomer">
                                <div class="row gy-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label" for="customer-username">اسم المستخدم</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="form-label-group">
                                                <label class="form-label" for="customer-password">كلمة السر</label>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="form-label-group">
                                                <label class="form-label" for="customer-confirmPassword">تأكيد كلمة السر</label>
                                            </div>
                                            <div class="form-control-wrap">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <div class="form-control-select">
                                                    <select class="form-control" id="customer-city" name="city" onChange="getAreas(this.value);">
    ...
    <!-- @@ Edit Admin Modal @e --> 
    <div class="modal fade" tabindex="-1" role="dialog" id="edit-customer-modal">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <a href="#" class="close" data-dismiss="modal"><em class="icon ni ni-cross-sm"></em></a>
                <div class="modal-body modal-body-lg">
                    <h5 class="title" id="myModalLabel">تعديل بيانات العميل</h5>
                    <div class="tab-content">
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <div class="form-control-select">
                                                    <select class="form-control" id="edit-customer-city" name="city" onChange="getAreas(this.value);">
                                                        <option value="">اختر مدينة</option>
                                                        <?php
                                                            $stmt = $pdo->prepare('SELECT * FROM cities');
                                                            $stmt->execute();
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <div class="form-control-select">
                                                    <select class="form-control" id="edit-customer-area" name="area">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="phone" class="form-control form-control-lg" id="edit-phone-no" placeholder="ادخل رقم هاتفك" required>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <ul class="align-center flex-wrap flex-sm-nowrap gx-4 gy-2">
                                            <li>
                                                ...
                                                <input type="submit" name="editUser" class="btn btn-lg btn-primary" value="تحديث">
                                            </li>
                                            <li>
                                                <a href="#" data-dismiss="modal" class="link link-light">الغاء</a>
                                            </li>
