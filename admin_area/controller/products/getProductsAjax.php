...
$stmt = $pdo->prepare('SELECT p.*, b.slug as brand_name, s.sku, s.qty, pc.category_id, c.slug as category_name, f.path
                        FROM products p
                        JOIN stock s
                        ...
                        LEFT JOIN files f
                            ON p.id = f.entity_id AND zone = "baseImage"
                        ORDER BY p.id DESC');
$stmt->execute();
?>
        ...
        <div class="nk-tb-item">
            ...
            <div class="nk-tb-col tb-col-sm">
                <span class="tb-product">
                    <img src="<?= $product['path']?>" alt="" class="thumb">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <ul class="link-list-opt no-bdr">
                                    ...
                                    <li>
                                        <a href="controller/products/getProductImage.php?id=<?= $product['id']?>&pname=<?= $product['slug']?>"><em class="icon ni ni-camera"></em><span>صورة المنتج</span></a>
                                    </li>
                                    <li>
                                    <?php 
                                        if ($product['is_active'] === 1)
