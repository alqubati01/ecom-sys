                ...
                if ($stmt->rowCount())
                {
                    switch ($_POST['action'])
                    {
                        case 'active':
                            ...
                            if ($stmt->rowCount())
                            {
                                echo json_encode(['status'=> 202, 'message'=> 'تم تنشيط العميل']);
                                exit();
                            }
                            else
                            {
                                echo json_encode(['status'=> 303, 'message'=> 'فشل في تنشيط العميل']);
                                exit();
                            }
                            break;
                        case 'stop':
                            ...
                            if ($stmt->rowCount())
                            {
                                echo json_encode(['status'=> 202, 'message'=> 'تم ايقاف العميل']);
                                exit();
                            }
                            else
                            {
                                echo json_encode(['status'=> 303, 'message'=> 'فشل في ايقاف العميل']);
                                exit();
                            }
                            break;
                    }
